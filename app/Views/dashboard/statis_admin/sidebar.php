...
<li class="nav-item">
    ...
    <div id="kelolaProfile" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="cards.html">Verifikasi Lanjut</a>
        </div>
    </div>
</li>
<!-- Kelola hewan -->
...
<li class="nav-item">
    ...
    <div id="kelolaHewan" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="buttons.html">Cek Hewan</a>
            <a class="collapse-item" href="cards.html">Adopsi</a>
        </div>
    </div>
</li>
