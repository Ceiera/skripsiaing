...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <table>
            <tr>
                <td><a href="<?= base_url('dashboard/kelolahewan/tambah')?>" class="btn btn-primary btn-user btn-block">Tambah</a></td>
            </tr>
        </table>
    </div>
</div>
...
use PhpParser\Node\Stmt\Echo_;
 ...
 foreach ($data as $key) { ?>
                            <tr>
                                ...
                                <td align="center">
                                    <?= form_open('dashboard/kelolahewan/edit');?>
                                        <button name="id_hewan" type="submit" class="btn btn-warning " value="<?php echo($key['id_hewan']) ;?>">Edit</button>
                                    <?= form_close()?>
                                   
                                </td>
                                <td align="center">
                                     <?= form_open('dashboard/kelolahewan/hapus');?>
